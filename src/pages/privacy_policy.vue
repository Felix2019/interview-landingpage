    ...
    <div class="p-5 space-y-4 bg-background">
      ...
      <ul class="m-elements">
        ...
        <li>
          ...
          für die Öffentlichkeit oder nur für bestimmte Personengruppen
          sichtbar, bzw. zugänglich sind.
        </li>
        <li>
      ...
      <ul class="m-elements">
        ...
        <li>
          <strong>Einstellung der Sichtbarkeit von Beiträgen: </strong>Die
          Nutzer können mittels Einstellungen bestimmen, in welchem Umfang die
          von ihnen erstellten Beiträge und Inhalte für die Öffentlichkeit oder
          nur für bestimmte Personen oder Gruppen sichtbar, bzw. zugänglich
          sind.
        </li>
        <li>
      ...
      <ul class="m-elements">
        <li>
          ...
          vom Anbieter Google zum Zwecke einer technisch sicheren,
          ...
          wird die IP-Adresse des Nutzers mitgeteilt, damit Google die Schriften
          im Browser der Nutzer bereitstellen kann. Darüber hinaus werden
