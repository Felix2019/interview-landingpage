<template>
  <div class="p-6 space-y-4 bg-background">
    <h1 class="font-bold text-lg">Privacy Policy</h1>
    ...
    <p>Felix Günthner<br />Kyffhäuserstr. 57<br />50674, Köln, Deutschland</p>
    E-Mail-Adresse:
    <p>
      <a href="mailto:turtlelab.developer@gmail.com"
        >turtlelab.developer@gmail.com</a
      >
    </p>
    Impressum:
    <p>
      <a href="https://interview-app.com/imprint" target="_blank"
        >https://interview-app.com/imprint</a
      >
    </p>
    ...
    <p>
      ...
      entsprechend den gesetzlichen Vorgaben im Art. 21 DSGVO einlegen (weitere
      Hinweise zum Widerspruch erfolgen im Rahmen dieser Datenschutzerklärung).
      Nutzer können Ihren Widerspruch auch mittels der Einstellungen Ihres
      Browsers erklären.
    </p>
    <p>
      <strong
    ...
    <ul class="m-elements">
      ...
      <li>
        ...
        können mittels Einstellungen bestimmen, in welchem Umfang ihre Profile
        für die Öffentlichkeit oder nur für bestimmte Personengruppen sichtbar,
        bzw. zugänglich sind.
      </li>
      <li>
        <strong>Zwei-Faktor-Authentifizierung: </strong>Die
        Zwei-Faktor-Authentifizierung bietet eine zusätzliche Sicherheitsebene
        für Ihr Benutzerkonto und stellt sicher, dass nur Sie auf Ihr Konto
        zugreifen können, auch, wenn jemand anderes Ihr Passwort kennt. Zu
    ...
    <ul class="m-elements">
      <li>
        ...
        erstellten Beiträge und Inhalte sind öffentlich sichtbar und zugänglich.
      </li>
      <li>
      ...
      <li>
        ...
        rechtswidrigen Beiträgen zu Zwecken der Rechtsverfolgung entstehen. Wir
        weisen darauf hin, dass neben den Inhalten der Beiträge auch deren
      ...
      <li>
        ...
        welche Daten sie über sich innerhalb unseres Onlineangebotes preisgeben.
        Zum Beispiel, wenn Nutzer Angaben zur eigenen Person machen oder an
        Konversationen teilnehmen. Wir bitten die Nutzer ihre Daten zu schützen
        und persönliche Daten nur mit Bedacht und nur im erforderlichen Umfang
        zu veröffentlichen. Insbesondere bitten wir die Nutzer zu beachten, dass
        sie die Zugangsdaten ganz besonders schützen und sichere Passwörter
        verwenden müssen (d.h. vor allem möglichst lange und zufällige
    ...
    <ul class="m-elements">
      <li>
        ...
        Messung von Nutzerströmen; <strong>Dienstanbieter:</strong> Google
        Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland,
        Mutterunternehmen: Google LLC, 1600 Amphitheatre Parkway, Mountain View,
        CA 94043, USA; <strong>Website:</strong>
        <a
    ...
    <ul class="m-elements">
      <li>
        ...
        Park, CA, 94025, USA; <strong>Website:</strong>
      ...
      <li>
        <strong>Snapchat: </strong>Soziales Netzwerk;
        <strong>Dienstanbieter:</strong> Snap Inc., 3000 31st Street, Santa
        Monica, California 90405 USA; <strong>Website:</strong>
        <a href="https://www.snapchat.com/" target="_blank"
          >https://www.snapchat.com/</a
        >; <strong>Datenschutzerklärung:</strong>
        <a
        ...
        >, Cookie-Richtlinie:
        <a href="https://www.snap.com/de-DE/cookie-policy" target="_blank"
          >https://www.snap.com/de-DE/cookie-policy</a
        >;
        <strong
          >Standardvertragsklauseln (Gewährleistung Datenschutzniveau bei
          Verarbeitung in Drittländern):</strong
      ...
      <li>
        ...
        <strong>Dienstanbieter:</strong> musical.ly Inc., 10351 Santa Monica
        Blvd #310, Los Angeles, CA 90025 USA; <strong>Website:</strong>
    ...
    <ul class="m-elements">
      <li>
        <strong>Google Fonts: </strong>Bezug von Schriftarten ("Google Fonts")
        vom Anbieter Google zum Zwecke einer technisch sicheren, wartungsfreien
        und effizienten Nutzung von Schriftarten im Hinblick auf Aktualität und
        Ladezeiten, deren einheitliche Darstellung und Berücksichtigung
        ...
        erforderlich sind. ; <strong>Dienstanbieter:</strong> Google Ireland
